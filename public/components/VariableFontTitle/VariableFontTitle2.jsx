...
let numOfShadows = Array.from(Array(10));
...
const VariableFontTitle2 = ({ title, isInTransit }) => {
  ...
  var Char = function (container, char) {
    ...
    this.update = function (args) {
      ...
      this.shadow = args.shadow ? this.getAttr(dist, 0, 10).toFixed(1) : 0.5;
      //Compressa
    ...
    this.draw = function () {
      ...
      style +=
        ...
        numOfShadows.map(
          (_, i) =>
            `${(this.shadow / numOfShadows.length) * i}px ${
              (this.shadow / numOfShadows.length) * i
            }px 0 #33322d`
        );
      span.style = style;
    };
...
export default VariableFontTitle2;
